"""Decodes one shard with either our vendored protos or Waymo's and prints it as
JSON, so runner.py can compare the two.
"""
...
def extract_ours(shard_path: Path | str,
    ...
    vendored scenario_pb2, for comparison.
    """
